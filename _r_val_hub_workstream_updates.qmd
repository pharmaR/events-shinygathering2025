...
* Risk is managed not by itemized requirements, but by good development practices.[^csa]
...
![](resources/rvalhub-comm-channels.svg)
...
needs a body, quarto-dev/quarto-cli/issues/9821
</span>
:::
...
![](resources/repository-diagram.svg){.r-stretch .center style="display: block; margin: auto"}
