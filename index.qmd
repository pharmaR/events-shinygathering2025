...
_There are `n` packages for `x`, which one is the best?[^best-package]_

![](resources/choosing_a_package.png)

[^best-package]: [https://stackoverflow.com/questions/28650957]()
...
### By choosing packages, we're choosing our [^it-depends]
...
[^it-depends]: [It depends: A dialog about dependencies, Jim Hester (2019)](https://www.jimhester.com/talk/2019-rsc-deps/)
