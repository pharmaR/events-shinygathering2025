...
write.dcf(packages, "ORG_PACKAGES")
...
Calculates package quality metadata on for updated packages and reverse dependencies
:::
...
:::: {.columns}
::: {.column .center width="32%"}
<div style="filter: grayscale() contrast(50%) brightness(80%) sepia() saturate(1000%) hue-rotate(3.3rad);">
...
* Informed decisions on system-generalizability
* Tools can be re-applied to other platforms
:::
...
* Consensus base images
* Health authority container adoption..
:::
::::
